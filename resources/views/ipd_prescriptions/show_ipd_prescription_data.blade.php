            ...
            <div class="row">
                ...
                <div class="col-md-10 text-end">
                    <p class="fw-bolder text-gray-800 fs-6 mb-2">{{ __('messages.common.address').':' }} <b
                            class="fw-bold fs-7 text-gray-600">{{ getSettingValue('hospital_address') }}</b></p>
                    <p class="fw-bolder text-gray-800 fs-6 mb-2">{{ __('messages.user.phone').':' }} <b
                            class="fw-bold fs-7 text-gray-600">{{ getSettingValue('hospital_phone') }}</b></p>
                    <p class="fw-bolder text-gray-800 fs-6 mb-2">{{ __('messages.user.email').':' }} <b
                            class="fw-bold fs-7 text-gray-600">{{ getSettingValue('hospital_email') }}</b></p>
