...
@section('content')
    ...
    <div class="card">
                        ...
                        <div
                            ...
                            @if(count($checkDoctorSchedule) != 1)
                                <div class="menu-item px-5">
                                    <a href="{{ route('schedules.create') }}" class="menu-link px-5">
                                        {{ __('messages.schedule.new') }}
                                    </a>
                                </div>
                            @endif
                            <div class="menu-item px-5">
                                <a href="{{ route('schedules.excel') }}" class="menu-link px-5">
        ...
        <div class="card-body pt-0 fs-6 py-8 px-8 px-lg-10 text-gray-700 mt-5">
