            ...
            <div class="card-toolbar">
                <div class="d-flex align-items-center py-1">
                    <a href="{{ route('appointment-calendars.index') }}"
                       class="btn btn-icon btn-light btn-active-primary me-2">
                        <i class="fas fa-calendar-alt fs-3"></i>
                    </a>
                    <div class="me-4">
                        <a href="#" class="btn btn-flex btn-light btn-light-primary fw-bolder"
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-10">
                                    ...
                                    {{ Form::select('status', $statusArr,null, ['id' => 'status', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-selector select2-hidden-accessible data-allow-clear="true"']) }}
                                </div>
                                <div class="mb-10">
                                    <label
                                            class="form-label fs-6 fw-bold">{{ __('messages.appointment.date').':' }}</label>
                                    <div>
                    ...
                    @if (Auth::user()->hasRole('Patient|Receptionist'))
                        <a href="#" class="btn btn-primary ps-7 show menu-dropdown" data-kt-menu-trigger="click"
                           ...
                           data-kt-menu-flip="bottom">{{ __('messages.appointment.new_appointment') }}
                        ...
                        <div
                            ...
                            <div class="menu-item px-5">
                                <a href="{{ route('appointments.create') }}"
                                   class="menu-link px-5">{{ __('messages.appointment.new_appointment') }}</a>
                                <div class="menu-item px-5">
                                    <a href="{{ route('appointments.excel') }}"
