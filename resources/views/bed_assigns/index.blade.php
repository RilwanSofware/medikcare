                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-10">
                                    ...
                                    {{ Form::select('status', $statusArr, null, ['id' => 'filter_status', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-filter']) }}
                                </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-200px fs-6"
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('bed-status') }}"
                               class="menu-link px-5">{{ __('messages.bed_status.bed_status') }}</a>
                        </div>
                        <div class="menu-item px-5">
                            <a href="{{ route('bed-assigns.create') }}"
                               class="menu-link px-5">{{ __('messages.bed_assign.new_bed_assign') }}</a>
                        </div>
                        @if(Auth::user()->hasRole('Nurse|Doctor'))
                            <div class="menu-item px-5">
                                <a href="{{ route('bed.assigns.excel') }}"
