                ...
                <span class="svg-icon svg-icon-5 svg-icon-gray-500 me-1">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-10">
                                    <label
                                        class="form-label fs-6 fw-bold">{{ __('messages.call_log.call_type').':' }}</label>
                                    {{ Form::select('callType', $callTypeArr,null, ['id' => 'callType', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-selector select2-hidden-accessible data-allow-clear="true"']) }}
                                </div>
                    ...
                    <div
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('call_logs.create') }}"
                               class="menu-link px-5">{{ __('messages.call_log.new') }}</a>
                        </div>
                        <div class="menu-item px-5">
