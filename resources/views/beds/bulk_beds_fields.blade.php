<div class="col-sm-12">
    <div class="table-responsive-sm">
        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="bulkBedsTbl">
            ...
            <td class="bed_type">
                {{ Form::select('bed_type[]', $bedTypes, null, ['class' => 'form-select bedType form-select-solid fw-bold', 'id' => 'bedType', 'required', 'placeholder'=>'Select Bed Type', 'data-control' => 'select2']) }}
            </td>
            <td class="rate">
