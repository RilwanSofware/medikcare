                ...
                <span class="svg-icon svg-icon-5 svg-icon-gray-500 me-1">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-10">
                                    <label
                                        class="form-label fs-6 fw-bold">{{ __('messages.common.is_available').':' }}</label>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-200px fs-6"
                        ...
                        <div class="menu-item px-5">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#addModal"
                               class="menu-link px-5">{{ __('messages.bed.bed') }}</a>
                        </div>
                        <div class="menu-item px-5">
                            <a href="{{ route('create.bulk.beds') }}"
                               class="menu-link px-5">{{ __('messages.bed.new_bulk_bed') }}</a>
                        </div>
