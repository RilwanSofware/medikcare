            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('consultation_title', '', ['class' => 'form-control consultation-title form-control-solid','required']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::text('consultation_date', '', ['class' => 'form-control consultation-date form-control-solid','required', 'autocomplete' => 'off']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::number('consultation_duration_minutes', '', ['class' => 'form-control consultation-duration-minutes form-control-solid','required', 'min' => '0', 'max' => '720']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('patient_id', __('messages.blood_issue.patient_name').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::select('patient_id', $patients, null, ['class' => 'form-select form-select-solid patient-name', 'placeholder' => 'Select Patient Name', 'id' => 'patientName', 'required', 'data-control'=>'select2']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('doctor_id', __('messages.blood_issue.doctor_name').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::select('doctor_id', $doctors, null, ['class' => 'form-select form-select-solid doctor-name', 'placeholder' => 'Select Doctor Name', 'required','data-control'=>'select2']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        {{ Form::label('type', __('messages.live_consultation.type').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::select('type', $type, null, ['class' => 'form-select form-select-solid select2Selector consultation-type', 'placeholder' => 'Select Type', 'disabled', 'required', 'data-control'=>'select2']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::textarea('description', '', ['class' => 'form-control description form-control-solid', 'rows' => 3]) }}
                    </div>
                </div>
