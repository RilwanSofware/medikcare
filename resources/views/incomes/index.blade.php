        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <span class="svg-icon svg-icon-5 svg-icon-gray-500 me-1">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_6113c71822d0d">
                            <div class="px-7 py-5">
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-10">
                                    <label
                                        class="form-label fs-6 fw-bold">{{ __('messages.incomes.income_head').':' }}</label>
                                    {{ Form::select('income_head', $filterIncomeHeads, null,['id' => 'incomeHead', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-filter']) }}
                                </div>
                                <div class="d-flex justify-content-end">
                                    <button type="reset" class="btn btn-sm fs-6 btn-light btn-active-light-primary me-2"
                                            id="resetFilter"
                                            data-kt-menu-dismiss="flase">{{ __('messages.common.reset') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-200px fs-6"
                        ...
                        <div class="menu-item px-5">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#addModal"
                               class="menu-link px-5">{{ __('messages.incomes.new_income') }}</a>
                        </div>
                        <div class="menu-item px-5">
