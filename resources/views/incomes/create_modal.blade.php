    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.incomes.new_income') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('income_head', $incomeHeads, null, ['class' => 'form-select form-select-solid select2Selector', 'required', 'id' => 'incomeId', 'placeholder' => __('messages.incomes.select_income_head'), 'data-control' => 'select2']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
