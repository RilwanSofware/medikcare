                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12 mb-5">
                        <div class="form-group">
                            ...
                            {{ Form::text('report_date', null, ['class' => 'form-control form-control-solid','id' => 'reportDate','autocomplete' => 'off', 'required']) }}
                        </div>
                    </div>
                    <div class="form-group col-md-12 mb-5">
                        <div class="form-group">
                        ...
                        <div class="row2">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true">
                                ...
                                <label
                                    ...
                                    <input type="file" name="file" id="documentImage"
                    ...
                    <button type="button" id="btnCancel" class="btn btn-light btn-active-light-primary me-2"
