    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                @endif
                <div class="alert alert-danger display-none hide" id="editPaymentValidationErrorsBox"></div>
                ...
                <div class="row">
                    <div class="form-group col-md-6 mb-5">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                {{ Form::text('amount', null, ['class' => 'form-control form-control-solid price-input','id' => 'editIpdPaymentAmount', 'required']) }}
                    ...
                    <div class="form-group col-md-6 mb-5">
                        <div class="form-group">
                            ...
                            {{ Form::text('date', null, ['class' => 'form-control form-control-solid','id' => 'editIpdPaymentDate','autocomplete' => 'off', 'required']) }}
                        </div>
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('payment_mode', $paymentModes, null, ['class' => 'form-select form-select-solid select2Selector', 'id' => 'editPaymentModeId', 'required','placeholder'=>'Select Payment Mode']) }}
                    </div>
                        ...
                        <div class="row2">
                            ...
                            <div class="image-input image-input-outline" data-kt-image-input="true" style="">
                                ...
                                <label
                                    ...
                                    <input type="file" name="file" id="editPaymentDocumentImage"
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            {{ Form::textarea('notes', null, ['class' => 'form-control form-control-solid', 'rows' => 4,'id'=>'editIpdPaymentNote']) }}
                        </div>
                    </div>
