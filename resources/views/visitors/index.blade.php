                    ...
                    <div class="me-4">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-10">
                                    <label
                                        class="form-label fs-6 fw-bold">{{ __('messages.visitor.purpose').':' }}</label>
                                    {{ Form::select('purpose', $purpose,null, ['id' => 'purposeArr', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-selector select2-hidden-accessible data-allow-clear="true"']) }}
                                </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-bold py-4 w-200px fs-6"
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('visitors.create') }}"
                               class="menu-link px-5">{{ __('messages.visitor.new') }}</a>
                        </div>
                        <div class="menu-item px-5">
