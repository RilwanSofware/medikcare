...
<img src="{{ ($frontSetting['home_page_image']) ? $frontSetting['home_page_image'] : mix('web_front/images/main-banner/banner-one/woman-doctor.png') }}"
                        ...
                        <div class="banner-image-shape-1" data-aos="fade-up" data-aos-delay="50"
                             data-aos-duration="500">
                            <img src="web_front/images/main-banner/banner-one/banner-shape-1.png" alt="image">
                        </div>

                        <div class="banner-image-shape-2" data-aos="fade-up" data-aos-delay="70"
                             data-aos-duration="700">
                            <img src="web_front/images/main-banner/banner-one/banner-shape-2.png" alt="image">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="why-choose-area ptb-100">
        ...
        <div class="why-choose-shape-1" data-speed="0.08" data-revert="true">
            <img src="web_front/images/why-choose/shape-1.png" alt="image">
        </div>

        <div class="why-choose-shape-2" data-speed="0.08" data-revert="true">
            <img src="web_front/images/why-choose/shape-2.png" alt="image">
        </div>
    </div>
    <!-- End Why Choose Area -->
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 our-service-cards">
                        <div class="single-services-card h-100">
                            ...
                            <div class="services-shape-1">
                                <img src="web_front/images/services/shape-1.png" alt="image">
                            </div>
                        </div>
                    </div>
                @endforeach
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="healthcare-doctor-content" data-speed="0.05" data-revert="true">
                        ...
                        <div class="healthcare-stethoscope">
                            <img src="web_front/images/healthcare-doctor/stethoscope.png" alt="image">
                        </div>
                    </div>
                </div>
    ...
    <div class="professional-doctors-area ptb-100">
        ...
        <div class="professional-doctors-shape-1">
            <img src="web_front/images/doctors/shape-1.png" alt="image">
        </div>
    </div>
