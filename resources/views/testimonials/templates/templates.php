<script class="testimonialTemplate" type="text/x-jsrender">
   <a href="javascript:void(0)" title="<?php echo __('messages.common.edit') ?>" class="btn btn-icon btn-bg-light edit-btn btn-active-color-primary btn-sm me-1" data-id="{{:id}}">
