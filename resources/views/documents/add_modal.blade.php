    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.document.new_document') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('document_type_id', $documentType, null, ['class' => 'form-select form-select-solid','required', 'id' => 'documentTypeId','placeholder' => __('messages.document.select_document_type'), 'data-control' => 'select2']) }}
                    </div>
                    ...
                    @else
                        <div class="form-group col-sm-6 mb-5">
                            <div>
                                ...
                                {{ Form::select('patient_id', $patients, null, ['class' => 'form-select form-select-solid','required', 'id' => 'patientId', 'placeholder' => __('messages.document.select_patient'), 'data-control' => 'select2']) }}
                            </div>
                        </div>
                    @endif
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true" style="">
                            ...
                            <label
                                ...
                                {{ Form::file('file',['id'=>'documentImage','class' => 'd-none']) }}
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::textarea('notes', null, ['class' => 'form-control form-control-solid', 'rows' => 5]) }}
                    </div>
                </div>
