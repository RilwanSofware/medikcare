    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.front_services.new_service') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::textarea('short_description', null, ['class' => 'form-control form-control-solid','rows' => 6]) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true" style="">
                            <div class="image-input-wrapper w-125px h-125px bgi-position-center" id="previewImage"
                                 style="background-image: url({{ asset('web_front/images/services/medicine.png') }})">
                            </div>
                            <label
                                ...
                                {{ Form::file('icon',['id'=>'icon','class' => 'd-none document-file']) }}
