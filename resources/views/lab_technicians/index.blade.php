                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-10">
                                    ...
                                    {{ Form::select('status', $statusArr,null, ['id' => 'filter_status', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-filter select2-hidden-accessible data-allow-clear="true"']) }}
                                </div>
                    ...
                    <div
                        ...
                        <div class="menu-item px-5">
                            <a href="{{ route('lab-technicians.create') }}"
                               class="menu-link px-5">{{ __('messages.lab_tech.new_lab_tech') }}</a>
                        </div>
                        <div class="menu-item px-5">
