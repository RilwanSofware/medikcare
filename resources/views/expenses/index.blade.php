                ...
                <span class="svg-icon svg-icon-5 svg-icon-gray-500 me-1">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
                            ...
                            <div class="px-7 py-5">
                                <div class="mb-10">
                                    <label
                                        class="form-label fs-6 fw-bold">{{ __('messages.expense.expense_head').':' }}</label>
                                    {{ Form::select('expense_head', $filterExpenseHeads, null,['id' => 'expenseHead', 'data-control' =>'select2', 'class' => 'form-select form-select-solid status-filter']) }}
                                </div>
                    ...
                    <div
                        ...
                        <div class="menu-item px-5">
                            <a href="#" data-bs-toggle="modal" data-bs-target="#addModal"
                               class="menu-link px-5">{{ __('messages.expense.new_expense') }}</a>
                        </div>
                        <div class="menu-item px-5">
