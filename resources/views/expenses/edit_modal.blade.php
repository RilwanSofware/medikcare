    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h2>{{ __('messages.expense.edit_expense') }}</h2>
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        {{ Form::select('expense_head', $expenseHeads, null, ['class' => 'form-select form-select-solid select2Selector', 'required', 'id' => 'editExpenseHeadId', 'data-control' => 'select2']) }}
                    </div>
                    <div class="form-group col-sm-6 mb-5">
                    ...
                    <div class="form-group col-sm-6 mb-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true" style="">
                            <div class="image-input-wrapper w-125px h-125px" id="editPreviewImage"
