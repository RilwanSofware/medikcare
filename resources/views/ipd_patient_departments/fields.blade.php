    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                {{ Form::select('patient_id', $data['patients'], null, ['class' => 'form-select form-select-solid fw-bold', 'required', 'id' => 'patientId', 'placeholder' => 'Select Patient', 'tabindex' => '1', 'data-control' => 'select2']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                {{ Form::text('ipd_number', $data['ipdNumber'], ['class' => 'form-control form-control-solid', 'readonly']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                {{ Form::number('height', 0, ['class' => 'form-control floatNumber form-control-solid', 'max' => '7', 'step' => '.01', 'tabindex' => '2']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                {{ Form::number('weight', 0, ['class' => 'form-control floatNumber form-control-solid', 'data-mask'=>'##0,00', 'max' => '200', 'step' => '.01', 'tabindex' => '3']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
    ...
    <div class="col-lg-3 col-md-6 col-sm-12">
        <div class="mb-5">
            <div class="mb-5">
                ...
                <span class="text-danger">*</span>
                {{ Form::select('bed_id', [null], null, ['class' => 'form-select form-select-solid fw-bold', 'required', 'id' => 'bedId', 'disabled', 'data-control' => 'select2', 'placeholder' => 'Choose Bed']) }}
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-6 col-sm-12">
