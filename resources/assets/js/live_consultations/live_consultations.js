...
$(document).ready(function () {
    ...
    $('#addModal').on('hidden.bs.modal', function () {
        ...
        $('#type_number').append($("<option selected=\"selected\" value=\"0\">Select Type</option>"));
    });
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.success) {
                    ...
                    $('#consultationDate').text(moment(liveConsultation.consultation_date).format('Do MMM, Y')+ ' ' +moment(liveConsultation.consultation_date).format('LT'));
